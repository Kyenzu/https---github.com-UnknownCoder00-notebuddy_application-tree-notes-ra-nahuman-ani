...
class MyArchive extends StatefulWidget {
  const MyArchive({super.key});

  @override
  State<MyArchive> createState() => _MyArchive();
}

class _MyArchive extends State<MyArchive> {
  ...
  void didChangeDependencies() {
    ...
    if (argument != null) {
      ...
      selectedItem = 'Archive'; // Default value
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const Center(
        child: Text(
          'Archive will appear here', // Placeholder for Reminders content
          style: TextStyle(
            color: Colors.white70,
            fontSize: 14,
          ),
